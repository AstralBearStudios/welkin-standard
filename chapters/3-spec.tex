...
\begin{itemize}
	...
	\item Specific sequences in $CHAR*$ are included in quotes. To avoid confusion, literal quotes are denoted with [']. % TODO: change above examples to use single quotes in math mode OR go back to using bnfgrammer
\end{itemize}
...
There are three fundamental variants of Welkin:
\begin{itemize}
